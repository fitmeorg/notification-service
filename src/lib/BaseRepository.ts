...
import { Filter, PaginationOptions } from 'src/common/types';
...
export class BaseRepository<T extends Document> {
  ...
  async count(filterSearch: FilterQuery<T>): Promise<number> {
    return this.model.countDocuments(filterSearch);
  }
